...
import edu.mayo.lpea.cad.cadence.security.core.service.CustomizableAppUserService;
...
@Configuration
@EnableJpaRepositories(basePackageClasses = {ContractRepository.class, ContractUserRepository.class})
@EntityScan(basePackageClasses = {ContractAppUser.class, Contract.class})
